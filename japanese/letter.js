...
Vue.component('letter', { 
	template:  `<div style="height: 100%; width: 100%; overflow: auto; display: flex; flex-direction: column;">
		<div style="display: flex; flex-direction: row; margin: 5px;">
			...
			<RadioGroup v-model="word" type="button" style="margin-left: 20px;">
		...
		<div style="margin-top: 50px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
			...
			<span id="letter" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">{{char}}</span>
		</div>
  </div>`,
	// 
	props: {
	...
	async mounted () {
		...
		letter.style.fontFamily = "ＭＳ Ｐゴシック";
