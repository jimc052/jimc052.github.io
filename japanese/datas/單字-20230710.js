...
あいさつ（する）	3		挨拶（する）		1	寒暄、問候
あいじょう	2		愛情		0	愛情
あいず	2		合図		1	暗號、信號
アイスクリーム	2		icecream		5	冰淇淋
あいする	2		愛する		3	愛慕、熱愛
あいそう	1		愛想		3	和藹可親、好感
あいだ	3		間		0	間、期間、間隔、關係
あいだがら	1		間柄		0	（人與人）關係
...
あがる	3		上がる		3	上漲、提高、昂揚
あかるい	4		明るい		0,3	明亮、開通	形容詞
...
あくしゅ	2		握手		1	握手
アクセサリー	3	*2	accessory		1,3	裝飾品、附屬品
...
あげる	4		上げる、挙げる		0	舉、懸掛、抬高、舉行
あげる	3		あげる「お祝いをあげる」		0	送、給
あげる	2	*0	揚げる		0	揚起、炸
あご	1		顎		2	下巴、頜、顎
あこがれ	1		憧れ		0	憧憬、向往
...
あたたかい	4		暖かい、温かい		4	溫暖、溫和	形容詞
あたたまる	2		暖まる、温まる		4	暖和、取暖
あたためる	2		暖める、温める		4	使…暖、使…熱
あたま	4		頭		0,3	頭、腦袋
あたらしい	4		新しい		4	新的、新式的	形容詞
あたり	2		辺り		1	附近
...
あとまわし	1		後回し		3	緩辦
あな	2		穴		2	洞、缺陷
アナウンサー	3		announcer		3	廣播員	職稱
あなた	4		貴方		2	你
あに	4		兄		1	哥哥	家族
あね	4		姉		0	姐姐、姊姊	家族
あの	4		あの	指示詞	0	那、那個
あの	4		あの	感動詞	0	哎、啊、嗯
アパート	4		apartmentbuilding		2	公寓	地點
あばれる	2		暴れる		0	鬧、放蕩
あびる	4		浴びる		0,3	浴、洗、淋
あぶない	4		危ない		0,3	危險的
あぶら	2		油、脂		0	油、脂肪
あぶらえ	1		油絵		3	油畫
アフリカ	3	*2	Africa		0	非洲
あぶる	2		炙る、焙る「火に〜」		2	烘、烤
あふれる	2		溢れる		3	滿、溢、充滿
アプローチ	1		approach		3	方法、入口、接近
あべこべ	1		あべこべ		0	反對、相反
あまい	4		甘い		0	甜、甜蜜、姑且、天真、不緊	形容詞
あまえる	1		甘える		0	撒嬌
あまぐ	1		雨具		2	雨具
あまくち	1		甘口		0	帯甜味的
...
（どうも）ありがとうございます・ました。	4		（どうも）有難う御座居ます・有難う-御座居ました。	挨拶語	(1)2・(1)2--4	謝謝、非常感謝
ありさま	1		有様		0,2	樣子、情況
ありのまま	1		有りの儘		0,5	據實
...
あるく	4		歩く		2	步行、走	動詞
アルコール	3		alcohol		0	酒精
アルバイト	3		Arbeit	ドイツ語	3	打工
...
あんしん（する）	3		安心（する）		0	安心、放心
あんせい	1		安静		0	安靜
あんぜん	3		安全		0	安全
あんてい	2		安定		0	安定、穩定性
アンテナ	2		antenna		0	天線
あんな	3		あんな		0	那樣的
あんない（する）	3		案内（する）		3	引導、指南
...
いきごむ	1		意気込む		3	幹勁
いきちがい	1		行き違い		0	走岔、(聯繫等)弄錯
いきなり	2		行き成り		0	突然、冷不防
いきもの	2		生物		2,3	有生命力的東西
いきる	3		生きる		2	生存、謀生、有效、活
いく//ゆく	4		行く		0	去	動詞
いく〜	2		幾〜		1	多少、許多
いくじ	2		育児		1	育兒
いくせい	1		育成		0	培養、培育
...
いくつ	4		幾つ		1	多少、幾個、幾歲
いくぶん	2		幾分		0	某種程度
いくら	4		幾ら		1	多少、多少錢、不論多少
いくら〜ても	3		いくら〜ても		1--1	即使多麼…也、不論…也…
いけ	4		池		2	池子
いけない	0	*2	いけない		0	不好、不可以
いけばな	2		生花		2	插花、生花
...
いたずら	2		悪戯		0	惡作劇
いただき	1		頂「山の〜」		0	頂部
いただきます。	4		頂きます。	挨拶語	5	我要吃了
いただく	3		頂く		4	〔謙讓語〕領、戴、吃、喝
いたって	1		至って		0,2	很、非常
いたみ	2		痛み		3	損傷、腐敗
いたむ	2		痛む		2	疼痛
いためる	1		炒める		3	炒
...
いちにち	4		一日		4	一日、終日
いちば	2		市場		1	市場
いちばん	4		一番	名詞//副詞	2//0	最初、最好//最、頂
いちぶ	2		一部		2	一部、一份
いちぶぶん	1		一部分		3	一部分
いちべつ	0	*1	一別//一瞥		0	一別//看一眼
...
いっしょ	4		一緒		0	一同、一起
いっしょう	2		一生		0	一生
いっしょうけんめい	3		一生懸命		5	非常努力、拼命
いっしん	1		一心		3	齊心
いっせい	2		一斉（に）		0	一齊
いっそ	1		いっそ		0	寧可、倒不如
いっそう	2		一層		0	更、越發
いったい	4		一体		0	一體、究竟、到底
いったい	1		一帯		0	一帶
いったん	2		一旦		0	一旦、既然
いっち	2		一致		0	一致
いつつ	4		五つ		2	五個、五歲
いってい	2		一定		0	統一規定、固定
いっていらっしゃい。	0	*3	行っていらっしゃい。	挨拶語	0,7	慢走
いってまいります。	3		行って参ります。	挨拶語	7	我走了
いつでも	2		何時でも		1	隨時、總是
いってらっしゃい。	3		行ってらっしゃい。	挨拶語	6	慢走
...
いらい	2		以来		1	以來、今後
いらいら	2		いらいら		1	著急
いらっしゃい（ませ）。	4		いらっしゃい（ませ）。	挨拶語	4(6)	請來、歡迎
いらっしゃる	3		いらっしゃる		4	在、來、去
いりぐち	4		入り口		0	入口、門口	地點
いりょう	2		医療		0,1	醫療、治療
いりょう	1		衣料		1	布料
いりょく	1		威力		1	威力
いる	4		居る		0	有、居住
...
インフォーメーション	0	*1	information		4	情報、詢問處
...
うお	2		魚		0	魚
うがい	2		嗽		0	漱口
うかがう	3		伺う「お宅に伺う」		0	拜訪
うかがう	3		伺う「話を伺う」		0	請教、打聽
...
うし	2		牛		0	牛
うしなう	2		失う		0	失去、失掉
うしろ	4		後ろ		0	後、後面、後方	方位
うず	1		渦		1	漩渦、渦流
うすい	4		薄い		0	薄的、淺的	形容詞
うすぐらい	2		薄暗い		0	微暗
うすめる	2		薄める		0	稀釋
...
うそつき	1		嘘つき		2	說謊的人
うた	4		歌		2	歌、歌曲
うたう	4		歌う		0	歌頌、頌揚、唱、鳴	動詞
うたがう	2		疑う		0	懷疑、疑惑
うたたね	1		転寝		0	假睡、打瞌睡
うち	4		家「わたしのうち」		0	家庭、房子、住宅
うち	3		うち「この二つのうち」「三つの〜」		0	〜之中	方位
...
うばう	2		奪う		2	搶奪、除去
うま	2		馬		2	馬
うまい	3		美味い、旨い//上手い、巧い		2	好吃的//巧妙、高明、方便
うまる	1		埋まる		0	埋
うまれ	2		生まれ		0	出生
うまれつき	1		生まれつき		0	天生
うまれる	4		生まれる		0	產生、出現
...
うりば	3		売り場		0	出售處、售票處、銷售處
うる	4		売る		0	賣、售、販賣
うるおう	1		潤う		3	滋潤
うるさい	4	*3	煩い		3	吵、麻煩的	形容詞
うれしい	3		嬉しい		3	開心、歡喜的、高興的
うれゆき	2		売れ行き		0	銷售狀況
うれる	2		売れる		0	暢銷、有名
うろうろ	2		うろうろ		1	徘徊、徬徨
うわ	0	*2	上〜		0	上面、表面、高
...
うんそう	1		運送		0	運送
うんちん	1		運賃		1	運費
うんてん（する）	3		運転（する）		0	運轉、駕駛、開車
うんてんしゅ	3		運転手		3	駕駛員
うんと	2		うんと	副詞	1	多、有的是、非常
うんどう（する）	3		運動（する）		0	運動、活動
...
えきたい	2		液体		0	液體
えさ	2		餌		2	飼料
エスカレーター	3		escalator		4	電動手扶梯、自動樓梯
えだ	3		枝		0	枝、樹枝
...
おいこす	2		追い越す		3	越過
おいこむ	1		追い込む		3	趕入
おいしい	4		美味しい		0	好吃的、美味的	形容詞
おいだす	1		追い出す		3	趕出去
おいつく	2		追い付く		3	追上
おいて	2	*1	於いて		1	在…
おいでになる	3		お出でになる		5	來、去
オイル	2		oil		1	油、石油
おいる	1		老いる		2	年老
おいわい	3		お祝い		0	祝福
おう	2		追う		0	追求、趕、驅逐
...
おおがら	1		大柄		0	體型大、個兒大
おおきい	4		大きい		3	大的、巨大的、高大的	形容詞
おおきな	4	*3	大きな		1	大、大的
オーケー	1		okay		1	好、可以
おおげさ	1		大袈裟		0	誇大、誇張、小題大作
オーケストラ	2		orchestra		3	管弦樂團
おおざっぱ	1		大雑把		3	草率地、粗枝大葉地
おおすじ	1		大筋		0	大綱、梗概、提綱
おおぜい	4		大勢		3	人數眾多、許多人、大家
おおぞら	1		大空		3	太空、天空
おおどおり	2		大通り		3	大街
オートバイ	3		auto+bicycle	和製英語	3	摩托車
オートマチック//オートマティク	1		automatic		4,5	自動的
オートメーション	2		automation		4	自動控制、自動裝置
オーバー	3		overcoat		1	外套、大衣
オーバー	2		over		1	外套
オーバーコート	0	*2	overcoat		1	外套、大衣
オーバーする	1		over		1	超過
...
おかあさん	4		お母さん		2	媽媽、令堂、母親
おかえり。	2		御帰り。	挨拶語	0	（你）回來了
おかえりなさい。	3		御帰りなさい。	挨拶語	6	（你）回來了
おかげ	3		御蔭		0	托福、多虧、多虧
おかけください。	2		御掛け-下さい。	挨拶語	0--3	請坐
おかげさまで。	3		御蔭様で。	挨拶語	0	託您的福
おかし	4		お菓子		2	點心	食物
おかしい	3	*1	可笑しい		3	可笑、奇怪的、滑稽
おかす	2	*2	犯す		2	違犯、冒犯
おかす	2		侵す		2	侵犯、侵害
おかず	2		おかず		0	菜、副食
おかね	4		お金		0	錢
...
おくりもの	3		贈り物		0	禮物
おくる	3		送る		0	送、送行、寄、推辭
おくれ	1		遅れ		0	落後、不時興、敗興、輸、敗
おくれる	3		遅れる		0	遲、耽誤、落後、後進
（では）おげんきで	4		（では）お元気で。	挨拶語	(1)2	（那麼）請多保重
おげんきですか。	2		御元気ですか。	挨拶語	2	近來好嗎
おこさん	3		お子さん		0	小孩、令郎（尊稱對方的兒子）
おこす	3		起こす		2	發生、引起、叫醒、喚醒
おごそか	1		厳か		2	嚴肅、莊重
...
おさら	4		お皿		0	盤子
おさん	1		お産		0	出產
おじ（さん）	4		叔父、伯父（さん）		0	伯父、叔父	家族
おしい	2		惜しい		2	可惜的
おじいさん	4		お爺さん		2	祖父、老爺爺	家族
おしいれ	3		押入れ		0	壁櫥
おしえ	1		教え		0	教訓
おしえる	4		教える		0	教導、指點、教授	動詞
おじぎ	2		御辞儀		0	敬禮
おしきる	1		押し切る		3	切斷
おしこむ	1		押し込む		3	闖入
おじさん	2		小父さん		0	老伯、叔叔	家族
おしむ	1		惜しむ		2	愛惜
おしゃべり	2		お喋り		2	愛說話
...
おだいじに。	3		御大事に。	挨拶語	0	請保重、請好好照顧身体
...
おてあげ	1		お手上げ		0	毫無辦法
おてあらい	4		御手洗い		3	廁所、洗手間
おでかけ	2		お出掛け		0	出門
おてつだいさん	2		お手伝いさん		2	幫傭
おと	3		音		2	聲音
おとうさん	4		お父さん		2	父親、爸爸
おとうと	4		弟		4	弟弟
おどおど	1		おどおど		1	提心吊膽
おどかす	2		脅かす		0	威脅、嚇唬
おとこ	4		男		3	男子
...
おどろき	1		驚き		4	吃驚、驚恐
おどろく	3		驚く		3	吃驚、驚訝、出乎意料
おないどし	1		同い年		2	同年、同歲
おなか	4		お腹		0	肚子
おなじ	4		同じ		0	一樣、相同
おに	2		鬼		2	鬼、怪物、冷酷的人
おにいさん	4		お兄さん		2	哥哥	家族
おねえさん	4		お姉さん		2	姊姊	家族
おねがいします。	4		御願い-します。	挨拶語	0--2	拜託您了、麻煩請…、請…
おのおの	2		各々		2	各自
おのずから	1		自ずから		0	自然而然地
おば	3		叔母		0	伯母
おば（さん）	4		叔母、伯母（さん）		0	伯母
おばあさん	4		お婆さん		2	祖母、老婆婆
おばさん	2		小母さん		0	大娘、大嬸
おはようございます。	4		御早う御座います。	挨拶語	8	早安、早
おび	2		帯		1	帶子
おびえる	1		怯える		0,3	害怕
おびただしい	1		夥しい		5	很多
おびやかす	2		脅かす		4	威脅、強迫
...
おめでとうございます。	3		御目出度う-御座居ます。	挨拶語	0--4	恭禧
...
おもいこむ	2		思い込む		0,4	深信
おもいだす	3		思い出す		2,4	回想起來、想起
おもいつき	1		思い付き		0	一時想起
おもいっきり	2		思い切り		0	盡情地
おもいつく	2		思い付く		0,4	忽然想起
おもいで	2		思い出		0	回憶
おもう	3		思う		2	想、認為
おもしろい	4		面白い		4	有趣、好笑	形容詞
おもたい	2		重たい		0	重、沉重的
おもちゃ	3		玩具		2	玩具
おもて	3		表		3	正面、表面
おもむき	1		趣		0	趣味
...
おやじ	1		親父		0	父親、老板
おやすみ。	2		お休み。	挨拶語	0	晚安
おやすみなさい。	4		お休みなさい。	挨拶語	6	晚安
おやつ	2		御八つ		2	點心（下午３點左右吃的）
おやゆび	2		親指		0	大姆指
およぎ	2		泳ぎ		3	游
およぐ	4		泳ぐ		2	泳游	動詞
およそ	2		およそ		0	大概
...
おろそか	1		疎か		2	草率、疏忽
おわり	3		終わり		0	結束、終點
おわる	4		終わる		0	終了、結束	動詞
おわる	3	*2	〜終わる	補助動詞		終了、結束
おん	2		音		0	聲色、音色
おん	2		恩		1	恩情、恩典
おんがく	4		音楽		0,1	音樂
おんけい	2		恩恵		0	恩惠
...
かげつ	4		〜箇月			個月
かけっこ	1		駆けっこ		2	賽跑
かける	4		掛ける「眼鏡をかける」		2	戴眼鏡
かける	4		掛ける「電話をかける」		2	打電話
かける	3		掛ける「椅子に腰をかける」		2	坐在…上
かける	3		掛ける「壁に絵を掛ける」		2	掛上
かける	3		掛ける「親に心配をかける」		2	把某種行動加到別人身上
かける	2		欠ける		0	缺少
かける	1		賭ける		2	賭、賭博
かける	1		駆ける		2	奔馳
...
かじ	2		家事		1	家務事
かしこい	2		賢い		3	聰明、伶俐
かしこまりました。	3		畏まりました。	挨拶語	6	〔謙讓語〕知道了、遵命
かしだし	2		貸し出し		0	出借
かしつ	2		過失		0	過失
かじつ	2		果実		1	果實
かしま	2		貸間		0	出租的房間
...
かせき	1		化石		0	化石
かせぐ	2		稼ぐ		2	工作、賺錢
カセット（テープ）	2		cassettetape		2(5)	卡帶盒、卡式錄音帶
かせん	2		下線		0	下線
かせん	1		河川		1	河川
かせん	1		化繊		0	化學纖維
かそ	1		過疎		1	(人口)稀疏、稀少
...
かぞく	4		家族		1	家族
かそくど	2		加速度		3	加速度
ガソリン	3		gasoline		0	汽油
ガソリンスタンド	3		gasoline+stand	和製英語	6	加油站
かた	4		方「この方」		0	(這)位
かた	3		〜方「読み方」			〜方法
かた	2		肩		2	肩膀
かた	2		型		2	原形、鑄型
...
かた〜	1		片〜		2	二者中之一
かたい	3	*2	固い、硬い、堅い		0	堅固、堅強、堅硬、生硬、有信用
かだい	1		課題		0	習題
がたい	2	*1	〜難い		0	難以〜
かたおもい	1		片思い		3	單戀
かたがた	2		方々		2	諸位、同時
...
かねつ	2		加熱		0	加熱
かねて	1		予て		1	事先、老早
かねもち//おかねもち	3		お・金持ち		0,4//0,3	有錢人
かねる	2		兼ねる		2	兼、兼任
かのう	2		可能		0	可能
かのじょ	3		彼女		0,1	她、女朋友
...
かむ	3		咬む、噛む		1	咬、
ガム	2		gum		1	口香糖
カムバック	1		comeback		1,3	復出、回來、復歸
カメラ	4		camera		1	相機	物品
...
かれ	3		彼		1	他、男朋友
カレー	4	*1	curry		0,1	咖哩	食物
ガレージ	1		garage		1,2	車庫
かれら	3		彼等		1	他們
かれる	2		枯れる		0	枯萎
かれる	1		涸れる		0	乾涸
カレンダー	4		calendar		2	月曆
かろう	1		過労		0	勞累過度
...
きりつ	2		規律		0,1	紀律
きりゅう	1		気流		0	氣流
きる	4		切る、斬る		1	斬、完結、完了
きる	4		着る		0,2	穿
きる	2		〜きる			完成、完結
きれ	2		布		2	布料
きれ	2		〜切			切片
きれい	4		綺麗		1	漂亮、美麗	形容詞
きれめ	1		切れ目		3	裂縫
きれる	2		切れる		2	斷、中斷、到期、用盡、能幹
キロ	2		kilo	フランス語	0	千…
キロ（グラム）	4		kilogramme	フランス語	0(3)	公斤
キロ（メートル）	4		kilomètre	フランス語	0(3)	公里
きろく	2		記録		0	記錄
ぎろん	2		議論		1	議論
ぎわく	1		疑惑		0	疑惑
きわめて	1		極めて		2	非常
...
クラス	4		class		1	班級、等級
くらす	2		暮らす		0	生活
グラス	4		glass/grass		0,1	玻璃杯、眼鏡//草
...
けさ	4		今朝		1	今天早上、今晨
けしき	3		景色		1	風景、景致
けしゴム	3	*2	gom	オランダ語	0	橡皮擦	物品
げしゃ	2		下車		0,1	下車
げしゅく（する）	3		下宿（する）		0	公寓、宿舍
げじゅん	2		下旬		0	下旬
けしょう	2		化粧		2	化妝、打扮
けす	4		消す		0	熄滅、關掉、抹去、關閉、解除
げすい	2		下水		0	髒水、下水道
...
げっきゅう	2		月給		0	月薪、工資
けっきょく	2		結局		0	結果、結局
けっこう	4		結構	名詞//な形容詞//副詞	0,3//1//1	構造、結構//很好//相當
けっこう	1		決行		0	決心、實行
けつごう	1		結合		0	結合
けっこん（する）	4		結婚（する）		0	結婚
けっさく	2		傑作		0	傑作
けっさん	1		決算		1	決算、清算
けっして	3		決して		0	決對不
げっしゃ	1		月謝		0	酬謝金、學費
...
けんい	1		権威		1	權勢、威望、權威
げんいん	3		原因		0	原因
けんか（する）	3		喧嘩（する）		0	口角、爭吵、打架
けんかい	2		見解		0	意見
げんかい	2		限界		0	界限
けんがく	2		見学		0	見習、考察
げんかん	4		玄関		1	門口、房子的正門
げんき	4		元気		1	元氣、精力、精神
けんきゅう（する）	3		研究（する）		0	研究
けんきゅうしつ	3		研究室		3	研究室
けんきょ	2		謙虚		1	謙虛
けんぎょう	1		兼業		0	兼營
...
こうご	1		交互		1	交替
こうこう	2		孝行		1	孝順
こうこう//こうとうがっこう	3		高校//高等学校		0//5	高中
こうこうせい	3		高校生		3	高中生
こうこうと	1		煌々と		0	煌煌
こうこがく	1		考古学		3	考古學
こうこく	2		広告		0	廣告
...
コート	2		coat		1	外套、大衣	服裝
コート	2		court		1	場地	
コート	4		overcoat		1	外套	服裝
コーナー	1		corner		1	角落、角、園區
コーヒー	4		koffie	オランダ語	3	咖啡	飲料
...
こげる	2		焦げる		2	糊、烤焦
ごげん	1		語源		0	語源
ここ	4		此処	指示詞	0	這裡、這個時候
ここ	1		個々		1	每個
ごご	4		午後		1	下午
こごえる	2		凍える		0	凍僵
ここち	1		心地		0	感覺、心情
ここのか	4		九日		4	九日、九天、九號
ここのつ	4		九つ		2	九個、九歲
こころ	3		心		0,2	心胸、心情、心、精神、真心、衷心、誠心、想法、心思、意志、關懷、體諒、人情、風格特色
...
こぜに	1		小銭		0	零（用）錢
ごぜん	4		午前		1	上午
ごぞんじ	3		御存知		2	你知道、你認識
ごぞんじですか。	2		御存知ですか。	挨拶語	2	您知道嗎
こたい	2		固体		0	固體
こだい	1		古代		1	古體、古式、古詩體
こたえ	3		答え		2	回答、答覆、（問題的）答案
こたえる	4		答える		2,3	答覆、報答	動詞
こたつ	1		火燵		0	（取暖用的）暖爐、被爐
こだわる	1		拘る		3	拘泥於
ごちそう	3		御馳走		0	盛宴、款待
ごちそうさま（でした）。	4		御馳走様（でした）。	挨拶語	0,6(7)	多謝您的款待、我已經吃飽了
こちょう	1		誇張		0	誇張、誇大
こちら	4		こちら		0	這裡、這邊、這位、這方面、我們
こちらこそ。	4		こちらこそ。	挨拶語	4	哪兒的話、不敢當
...
こっち	4	*3	こっち		3	這邊、這裡、這方面、我們、這位
こづつみ	2		小包		2	小包裏、郵寄的包裏
こっとうひん	1		骨董品		0	古董品
コップ	4		kop	オランダ語	0	杯子
こてい	1		固定		0	固定
こてん	2		古典		0	古典
こと	3		事		2	事情、情況、（談話的）內容
こと	2		琴		1	琴
ごと	2		〜毎			每
...
こな//こ	2		粉		2//1	粉末
こないだ	0	*2	こないだ		4	近來、前些天
こなごな	1		粉々		0	粉碎、粉末
この	4		此の	指示詞	0	這、這個
このあいだ	3		此の間		0,5	前些時候、前幾天、最近
このごろ	3		此の頃		0,2	近來
...
こめる	2	*1	込める		2	裝填、集中
ごめん	2		御免		0	拒絕、免職
ごめんください。	4		御免下さい。	挨拶語	6	有人在嗎？
コメント	1		comment		0,1	評論、注釋
ごめんなさい。	4		御免なさい。	挨拶語	5	對不起
こもる	1		籠もる		2	充滿
こや	2		小屋		0	簡陋的房子
こゆう	1		固有		0	固有、特有
こゆび	2		小指		0	小指、情婦
...
ごらんになる	3		ご覧になる		5	〔尊敬語〕看、觀覽
こりつ	1		孤立		0	孤立
こりる	1		懲りる		2	接受了〜的教訓
こる	1		凝る		1	凝固、熱衷
これ	4		此れ、是		0	此、這
これから	3		此れから		0,4	從今以後
...
こんご	2		今後		0	今後、以後
こんごう	2		混合		0	混合
コンサート	3		concert		1,3	演唱會、音樂會
こんざつ	2		混雑		1	混雜、擁擠
こんしゅう	4		今週		0	這星期
コンセント	2		concentric+plug	和製英語	1,3	插座、插口
コンタクト（レンズ）	1		contactlens		1,3[6]	隱形眼鏡
こんだて	2		献立		0,4	菜單、準備
こんちゅう	1		昆虫		0	昆蟲
こんてい	1		根底		0	根底、基礎
...
こんなん	2		困難		1	因難
こんにち	2		今日		1	今日
こんにちは。	4		今日は。	挨拶語	5	您好
コンパス	1		kompas	オランダ語	1	圓規、指南針
こんばん	4		今晩		1	今晚、今夜
こんばんは。	4		今晩は。	挨拶語	5	晚上好
コンピューター//コンピュータ	3	*2	computer		3	電腦
こんぽん	1		根本		0	根本、基礎
こんや	3		今夜		1	今夜、今晚
こんやく	2		婚約		0	婚約
こんらん	2		混乱		0	混亂
...
さあ	4		さあ	感動詞	1	喂（用於勸誘，催促時）、呀（用於躊躇，遅疑時）、啊（用於喜悦，驚訝）
...
さがる	3		下がる		2	下降、降低
さかん	3		盛ん		0	興盛、旺盛、繁榮、盛大、積極、熱烈、大力
さき	4		先		0	尖端、前頭、先、先前、前方、目的地、將來、前途
さぎ	1		詐欺		1	欺詐、詐騙
さき（に）	0	*2	先（に）		0	先、早、先前
さきおととい	2		一昨々日		4	大前天
...
さむい	4		寒い		2	寒冷、寒酸、簡陋	形容詞
さむけ	1		寒気		3	發冷、發抖
さむらい	1		侍		0	武士、剛毅果斷的人
さめる	2		冷める		2	變涼、減退
さめる	2		覚める		2	醒、醒悟
さも	1		然も		1	的確、實在(的樣子)、好像
さゆう	2		左右		1	左右、旁邊、影響
さよう	1		作用		1	作用
さよなら//さようなら。	4		さよなら//左様なら。	挨拶語	3,4//4,5	再見、再會
さら	2		皿		0	盤子、用盤子裝起來的菜
さらいげつ	3		再来月		0,2	下下個月
さらいしゅう	3		再来週		0	下下星期
さらいねん	4		再来年		0	後年
さらう	1		攫う「子供を〜」		0	拐走小孩
サラダ	3	*2	salad		1	沙拉
さらに	2		更に		1	更、（接否定）絲毫不
サラリーマン	2		salariedman		3	上班族、公司職員
さる	2		猿		1	猿猴
さる	2		去る		1	離開、走開、消失
さわがしい	2		騒がしい		4	吵鬧
さわぎ	2		騒ぎ		1	吵鬧、騷動
...
さんそ	2		酸素		1	氧
ざんだか	1		残高		1	餘額、結餘
サンタクロース	1		SantaClaus		5	聖誕老人
サンダル	3		sandal		0,1	拖鞋、涼鞋、皮帶鞋	服裝
さんち	2		産地		1	產地
さんちょう	1	*0	山頂		0	山頂
サンドイッチ	3		sandwich		4	三明治
サンドウィッチ	0	*2	sandwich		4	三明治
ざんねん	3		残念		3	遺憾、可惜
さんばし	1		桟橋		0	碼頭
さんび	1		賛美		1	讚美
さんぷく	1		山腹		0	山腰
...
じつに	2		実に		2	實在、非常、眞
じつは	2		実は		2	老實說、其實
しっぱい（する）	3		失敗（する）		0	失敗
じっぴ	1		実費		0	實際費用
しっぴつ	2		執筆		0	執筆、寫作
じつぶつ	2		実物		0	實物、現貨
しっぽ	2		尻尾		3	尾巴、末端
しつぼう	2		失望		0	失望
しつもん	4		質問		0	提問、發問、詢問
じつよう	2		実用		0	實用
じつりょく	2		実力		0	實力
じつれい	2		実例		0	實例
しつれい（する）	3		失礼（する）		2	失禮、不禮貌
しつれいしました。	4		失礼-しました。	挨拶語	2--2	告辭、再見、請原諒
しつれいします。	4		失礼-します。	挨拶語	2--2	告辭、再見、對不起
しつれん	2		失恋		0	失戀
してい	2		指定		0	指定
してき	1		指摘		0	指出
してつ	2		私鉄		0	民營鐵路
...
しゃしん	4		写真		0	照片、照相、相片
ジャズ	1		jazz		1	爵士樂
しゃせい	2		写生		0	寫生
しゃせつ	2		社説		0	社論
しゃぜつ	1		謝絶		0	謝絕
しゃたく	1		社宅		0	公司員工住宅
しゃちょう	3		社長		0	(公司)總經理、社長
シャツ	4		shirt		1	襯衫	服裝
じゃっかん	1		若干		0	若干、少許
しゃっきん	2		借金		0	借錢
しゃっくり	2		噦		1	打嗝兒
...
しゅっしん	2		出身		0	畢業、出生
しゅっせ	1		出世		0	出息、出名
しゅっせき（する）	3		出席（する）		0	出席、參加
しゅつだい	1		出題		0	出題
しゅっちょう	2		出張		0	出差
しゅつどう	1		出動		0	出動
しゅっぱつ（する）	3		出発（する）		0	出發、動身
しゅっぱん	2		出版		0	出版
しゅっぴ	1		出費		0	費用、開支
...
しょうたい	1		正体		1	真面目
じょうたい	2		状態		0	情形
しょうたい（する）	3		招待（する）		1	邀請
しょうだく	1		承諾		0	允許
じょうたつ	2		上達		0	（技藝、學業）進步
じょうだん	2		冗談		3	玩笑話
しょうち（する）	3		承知（する）		0	同意、知道
...
スーツ	3	*2	suit		1	套裝
スーツケース	3		suitcase		4	行李箱
ずうっと	2		ずうっと		0	一直
スーパー（マーケット）	3	*2	supermarket		1(5)	超級市場
すうはい	1		崇拝		0	崇拜
スープ	2		soup		1	湯
すえ	2		末		0	末尾
...
すばやい	1		素早い		3	靈活
すばらしい	3		素晴らしい		4	絕佳、了不起
ずばり	1		ずばり		2	直接了當
スピーカー	2		speaker		0,2	喇叭、擴音器、演講者
スピーチ	2		speach		2	演講
スピード	2		speed		0	速度
ずひょう	2		図表		0	圖表
スプーン	4		spoon		2	匙子、湯匙
ずぶぬれ	1		ずぶ濡れ		0	濕透、淋透
スプリング	1		spring		0,3	彈簧、春天
スペース	1		space		2	空間、餘地、場地、太空
すべて	2		全て		1	全部、一切
すべる	3		滑る		2	滑
スポーツ	4		sports		2	(體育)運動
スポーツカー	1		sportscar		4,5	跑車
ズボン	4		jupon	フランス語	1,2	褲子	服裝
...
ずらり	2		ずらり		2,3	並列、羅列
すり	3		掏摸		1	扒手
スリッパ	4		slipper		1,2	拖鞋	服裝
する	4		為る「行なう」		0	做
する	2		刷る		1	印刷
する	1		擦る		1	擦過、研磨
ずるい	2		狡い		2	狡猾
ずるずる	1		ずるずる		1	滑溜的、拖延、哧溜
すると	3		すると	接続詞	0	於是、然後
するどい	2		鋭い		3	銳利的、敏銳
ずれ	1		滑れ		2	不吻合、偏差
すれちがい	1		擦れ違い		0	擦身而過
すれちがう	2		擦れ違う		4	擦身而過
...
せんせい	2		専制		0	專制獨裁
ぜんせい	1		全盛		0,1	全盛
ぜんぜん	3		全然		0	一點也、完全、根本
せんせんげつ	2		先々月		0	上上個月
せんせんしゅう	2		先々週		0	上上個星期
せんぞ	2		先祖		1	始祖
せんそう（する）	3		戦争（する）		0	戰爭
センター	2		center		1	中心、中央
せんだい	1		先代		0	上一代
ぜんたい	2		全体		0	全身、整體
せんたく	2		選択		0	挑選
せんたく（する）	4		洗濯（する）		0	洗濯、洗衣服
せんだって	1		先達て		0,5	前幾天
せんたん	2		先端		0	頂端
...
そうさく	2		創作		0	創作
そうさく	1		捜索		0	搜索
そうじ（する）	4		掃除（する）		0	掃除、打掃
そうしき	2		葬式		0	葬禮
そうしつ	1	*0	喪失		0	喪失
そうして//そして	4		そうして//そして		0	然後、於是、而且
そうじゅう	1		操縦		0	駕駛、操縱
...
それで	3		其れで		0	所以、那麼、後來
それでは	4		其れでは		3	那麼、那樣的話
それでも	2		其れでも		3	儘管如此
それと	2		其れと		0	因此、那麼
それとも	2		其れとも		3	或者、還是
それなのに	2		其れなのに		3	儘管…可是
それなら	2		其れなら		3	那麼、那樣的話
それに	3		其れに		0	儘管那樣、而且、加上
それはいけませんね。	3		それは-いけませんね。	挨拶語	0--4	那樣不行喔
それほど	3		其れ程		0	那麼、那種程度
それゆえ	1		其れから		0	因此、所以
それる	2		逸れる		2	偏離、落空
...
たいそう	2		体操		0	體操
たいそう	2		大層		1	非常
だいたい	3		大体		0	大致、基本上、根本
たいだん	1		対談		0	對談
だいたん	1		大胆		3	大膽
たいてい	3	*4	大抵		0	大抵、大體上、基本上
たいど	2		態度		1	態度
たいとう	1		対等		0	對等、同等
だいとうりょう	2		大統領		3	總統
だいどころ	4		台所		0	廚房
...
だいぶん	2		大分	副詞	0	很、相當
たいへん	4		大変「たいへん暑い」	副詞	0	很、非常
たいへん	4		大変「それはたいへんですね」	形容動詞	0	嚴重、不得了
...
ダイヤグラム	0	*2	diagram		0,1	鐵路營運圈、列車時刻表
...
たおれる	3		倒れる		3	倒塌
だが	2		だが	接続詞	1	但是
たかい	4		高い「高い山」		2	高	形容詞
たかい	4		高い「値段が高い」		2	(價錢)貴	形容詞
たがい	2		互い		0	彼此、相互
だかい	1		打開		0	打開
たかまる	1		高まる		3	高漲
たかめる	2		高める		3	提高
...
たにん	2		他人		0	其他人
たね	2		種		1	種子
たのしい	4		楽しい		3	快樂、愉快	形容詞
たのしみ	3		楽しみ		3,4	快樂、期待
たのしむ	3	*2	楽しむ		3	享樂、快樂
...
ちい	2		地位		1	地位、職位
ちいき	2		地域		1	地域、地區
ちいさい	4		小さい		3	(體積等)小	形容詞
ちいさな	4	*3	小さな		1	微小的
チーズ	2		cheese		1	起司
チーム	2		team		1	隊(伍)、團隊、小組
チームワーク	1		teamwork		4	配合、協同動作
ちえ	2		知恵		2	智慧
チェック（する）	3	*0	check		1	查對、檢查
チェンジ	1		change		1	交換
ちか	2		地下		2	地下
ちかい	4		近い		2	(距離)近、接近的	形容詞
ちがい	2		違い		0	差異、差別
ちがいない	2		違いない		4	對的、沒錯的
ちかう	2		誓う		0,2	發誓、宣誓
ちがう	4		違う		0	不同、不一致	動詞
ちがえる	1		違える		0	改變、更改
ちかく	4		近く		1,2	附近、接近
ちかごろ	2		近頃		2	近來、近日
...
ちゅうこ	2		中古		1	中古
ちゅうこく	1		忠告		0	忠告
ちゅうし（する）	3	*2	中止（する）		0	中止
ちゅうじつ	1		忠実		0,1	忠實、如實
ちゅうしゃ	2		駐車		0	停車
ちゅうしゃ（する）	3		注射（する）		0	注射、打針
ちゅうしゃじょう	3		駐車場		0	停車場
ちゅうじゅん	2		中旬		0,1	中旬
ちゅうしょう	2		抽象		0	抽象
ちゅうしょう	1		中傷		0	中傷
ちゅうしょく	2		昼食		0	午餐
...
つかさどる	1		司る		4	掌管、管理
つかのま	1		束の間		0	一剎那
つかまえる	3		捕まえる		0	抓住、抓到、捉拿
つかまる	2		捕まえる		0	被捉住、被捕獲
つかむ	2		掴む		2	抓住、獲得
つかれ	2		疲れ		3	疲憊
つかれる	4		疲れる		3	疲勞、疲憊	動詞
つき	3		月「月と太陽」		2	月、月亮
つき	3		〜月			〜個月
つき	2		〜付			附
つぎ	4		次		2	下一個、接下來
...
つくる	4		作る		2	做、作、製作	動詞
つくる	3		作る		2	作
つくる	2		造る		2	製造、建造、組成
つくろう	1		繕う		3	修補
つけくわえる	1		付け加える		0,5	加、補充、附加
つける	4		点ける「電灯をつける」		2	開(燈)
つける	3		漬ける		0	醃
つける	3		付ける「気をつける」		2	加上、安上
つける	2		浸ける		0	浸
つける	2		着ける		2	點上、打開
つげる	1		告げる		0	告訴
つごう	3		都合		0	情況、總共
...
ていしゃ	2		停車		0	停車
ていしゅつ	2		提出		0	提出、提交
ティシュペーパー	0	*1	tissuepaper		3	衛生紙、紙手帕
ていしょく	1		定食		0	定食、客飯
ていせい	1		訂正		0	訂正
ていたい	1		停滞		0	停滯、停頓、滯銷
ていたく	1		邸宅		0	邸宅、公館
ティッシュ（ペーパー）	1		tissuepaper		1(4)	衛生紙、紙手帕
ていでん	2		停電		0	停電
ていど	2		程度		0,1	程度、水平、水準、限度
ていねい	3		丁寧		1	有禮貌、恭恭敬敬、鄭重其事、小心謹慎、非常仔細
ていねん	1		定年		0	退休的年齡
ていぼう	1		堤防		0	堤防、提壩
ていり	1	*0	定理		1	定理
...
できごと	2		出来事		2	事件、變故
テキスト	3		text		1,2	課本、原文
てきする	2		適する		3	適合、適當
てきせい	1		適性		0	適合、(某人)的性質、(某種工作)的性質、性格
てきど	2		適度		1	適度、適當的程度
てきとう	3		適当		0	適度、適合適宜、正好、正是時侯、隨便
できもの	1		出来物		2,3,4	疔瘡、膿腫、癤子
てきよう	2		適用		0	(法律、規則)適用、應用
できる	4		出来る「英語ができる」		2	會、能、成績好、有才能
できる	3		出来る「銀行ができる」		2	做成、建立、建成、形成、出現、生產、出產
...
でなおし	1		出直し		0	再來、重做
テニス	3	*2	tennis		1	網球
テニスコート	2	*3	tenniscourt		4	網球場
てぬぐい	2		手拭		0	布手巾
てのひら	1		掌		1	手掌
では	4		では	感動詞	1	那麼
では	2		では	接続詞	1	如果那樣
では，また。	4		では，-又。	挨拶語	1--0	那麼、再見
デパート	4		departmentstore		2	百貨公司	地點
てはい	1		手配		1,2	籌備、部署
てはず	1		手筈		1	步驟、程序
...
とうあん	2		答案		0	答案、試卷
どうい	1		同意		0	同意、贊成
（いいえ）どういたしまして。	4		（いいえ）何う-致しまして。	挨拶語	(3)1--4	不用客氣
...
とうめい	2		透明		0	透明
どうめい	1		同盟		0	同盟
どうも	4		どうも	副詞//感動詞	1	怎麼也、總是、實在//實在、太、謝謝
...
とぼしい	1		乏しい		3	缺乏、貧困
とまどい	1	*0	戸惑い		0,3	困惑
とまる	4		止まる		0	停止、止住	動詞
とまる	3		泊まる		0	住宿、停泊
とめる	3		止める		0	停止、停住、閉上
...
どんどん	3	*2	どんどん		1	連續不斷
どんな	4		どんな		1	怎樣的、什麼樣的
どんなに	2		どんなに		1	如何
トンネル	2		tunnel		0	隧道
どんぶり	2		丼		0	大碗
とんや	1		問屋		0	批發商
...
ならびに	1		並びに		0	和、以及
ならぶ	4		並ぶ		0	排列、兼備	動詞
ならべる	4		並べる		0	並列、列舉、陳列、排列
なりたつ	1		成り立つ		0,3	成立、組成
なる	4		為る「春になる」		1	成為、變成
なる	3		鳴る		0	鳴、鳴響、聞名
なる	2		生る		1	結果
なる	2		成る		1	完成、構成、達到、成為
なるたけ	1		成る丈		0	盡量
なるべく	3		成る可く		0	盡量、盡可能
なるほど	3		成る程		0	的確、原來如此
なれ	1		慣れ		2	熟練、習慣
...
にもつ	4		荷物		1	行李、貨物、負擔、累贅
ニュアンス	1		nuance		1	語感(的微妙差別)
ニュー	1		new		1	新(的)
にゅういん（する）	3		入院（する）		0	住院
にゅうがく（する）	3		入学（する）		0	入學
にゅうしゃ	2		入社		0	進入公司工作
...
のぼる	4		登る		0	攀登、登上、上升
のみこむ	1		飲み込む		0,3	嚥下
のみもの	4		飲み物		2,3	飲料	飲料
のむ	4		飲む		1	喝、吞	動詞
のり	2		糊		2	漿糊
のりかえ	2		乗り換え		0	換乘
のりかえる	3		乗り換える		3,4	換乘、改乘
のりこし	2		乗り越し		0	坐過站
のりこむ	1		乗り込む		3	乘入
のりもの	3		乗り物		0	交通工具
のる	4		乗る		0	乘坐、搭乘	動詞
...
パーティー	4		party		1	派對
パート（タイム）	3	*1	parttime		0,1(4)	非全日的、零工、臨時工
はい	4		はい	感動詞	1	是、好、可以
はい	4		〜杯			杯
はい	2		灰		0	灰
はい	1		肺		0	肺
はい	1		〜敗			輸、敗
...
はついく	1		発育		0	發育、成長
はつおん	3		発音		0	發音
はつか	4		二十日		0	二十號、二十日、二十天
はつが	1		発芽		0	發芽、出芽
はっき	2		発揮		0	發揮、施展
はっきり	3		はっきり		3	清楚
バック	0	*2	back		1	背景、後退
バッグ//ハンドバッグ	2		bag/handbag		1//4	(手提)包
はっくつ	2		発掘		0	發掘、挖掘
はっけん	2		発見		0	發現
はつげん	1		発言		0	發言
はっこう	2		発行		0	發放、發售
...
ばん	4		〜番			班、次序
ばん	2		番		1	看守、輪班
パン	4		pão	ポルトガル語	1	麵包	食物
はんい	2		範囲		1	範圍、界限
はんえい	2		反映		0	反映
はんえい	1		繁栄		0	興旺、繁榮
はんが	1		版画		0	版畫、木刻
ハンガー	1		hanger		1	衣架
ハンカチ	4		handkerchief		0,1,3	手帕
はんかん	1		反感		0	反感
はんきょう	1		反響		0	反應、回音
...
び	1		美		1	美麗、美好
ひあたり	2		日当たり		0	向陽處
ピアノ	3	*2	piano	イタリア語	0,1	鋼琴
ひいては	1		延いては		1,3	進而
ビール	2		bier	オランダ語	1	啤酒	飲料
ビールス	0	*1	virus		1	病毒、濾過性病原體
ひえる	3		冷える		2	變冷、感覺冷
ひがい	2		被害		1	受害
...
ひきょう	2		卑怯		2	懦弱、無恥
ひきわけ	2		引分		0	平手、不分勝負
ひく	4		引く		0	拉、拔、減去、查、遺傳
ひく	4		弾く		0	彈奏
ひく	2		轢く		0	壓
ひくい	4		低い		2	低的、低微的、矮的	形容詞
...
ひつよう	3		必要		0	必要、必需
ひてい	2		否定		0	否定
ビデオ	2		video		1	錄影機、錄影帶、攝影機	物品
ひと	4		人		0,2	人
ひと	2		一〜		0,2	一個、一下
ひどい	3		酷い		2	無情、殘酷的、厳重、極差
ひといき	1		一息		2	一口氣
ひとかげ	1		人影		0	人影
ひとがら	1		人柄		0	人品
ひとけ	1		人気		0	人的氣息
...
フィルム	4		film		1	底片、薄膜、電影
フイルム	0		film		0	底片、薄膜、電影
...
ふりょく	1		浮力		1	浮力
ぶりょく	1		武力		1	武力
プリント	2		print		0	印刷(物)、列印
ふる	4		降る		1	下、降	動詞
ふる	2		古〜		0	舊東西
ふる	2		振る		0	揮、招、搖、擺、撒
ふるい	4		古い		2	舊、老、以往、古老、年久	形容詞
ブルー	1		blue		2	青色、憂鬱
ふるえる	2		震える		0	顫動、發抖
...
へんきゃく	1	*0	返却		0	還、歸還
べんきょう（する）	4		勉強（する）		0	學習、用功
へんけん	1		偏見		0	偏見、偏執
べんご	1		弁護		1	辨解
へんこう	2		変更		0	變更、更改
へんさい	1		返済		0	還、還清
へんじ（する）	3		返事（する）		3	回答、回覆
へんしゅう	2		編集		0	編輯
べんじょ	2		便所		3	廁所
べんしょう	1		弁償		0	賠償
へんせん	1		変遷		0	變遷
...
ボールペン	4		ballpen		0	原子筆	物品
ほおん	1		保温		0	保溫
ほか	4		外		0	另外、其他、外部、別處
...
ぼきん	1		募金		0	募捐
ぼく	3		僕		0,1	我（男子用於客氣的場合）
ぼくし	1		牧師		0,1	牧師
ぼくじょう	2		牧場		0	牧場
ぼくちく	2		牧畜		0	畜牧
ほげい	1		捕鯨		0	補鯨
ポケット	4		pocket		1,2	口袋	物品
ぼける	1		惚ける、呆ける//暈ける		2	發呆//模糊
ほけん	2		保健		0	保健、保持健康	專業領域
ほけん	1		保険		0	保險	專業領域
ほご	1		保護		1	保護
ぼこう	1		母校		1	母校
ぼこく	1		母国		1	祖國
...
ほす	2		干す		1	烘乾
ポスター	2		poster		1	海報
ポスト	4	*2	post		1	郵筒、信箱、地位、職位
ほそい	4		細い		2	細的	形容詞
ほそう	1		舗装		0	鋪路
ほそく	1		補足		0	補充
ほぞん	2		保存		0	保存
ボタン	4		botão/button	ポルトガル語,英語	0,1	鈕扣//按鍵	物品
ぼち	1		墓地		1	墓地
ほっきょく	2		北極		0	北極
ほっさ	1		発作		0	發作
ぼっしゅう	1		没収		0	沒收
...
まず	3		先ず		1	先、首先
ますい	1		麻酔		0	麻醉
まずい	4		不味い		2	難吃、不妙	形容詞
マスク	2		mask		1	(假)面具、容貌
マスコミ	1		masscommunication		0	大眾傳播、大眾宣傳
まずしい	2		貧しい		3	貧窮的
...
まっしろ	2		真白		3	潔白
まっしろい	2		真白い		4	雪白
まっすぐ・に	4		真っ直ぐ・真っ直ぐに		3	筆直、直接
まったく	2		全く		0	完全
マッチ	4		match		1	火柴、調和、比賽
まっぷたつ	1		真っ二つ		3	兩半
まつり	2		祭		0,3	祭典、節
...
みこん	1		未婚		0	未婚
みさき	2		岬		0	海角
みじかい	4		短い		3	短、短暫	形容詞
みじめ	2		惨め		1	悲慘
みじゅく	1		未熟		0,1	未成熟
ミシン	2		sewingmachine		1	縫紉機
みじん	1		微塵		0	微小
ミス	2		miss		1	錯誤、失誤
ミス	1		Miss		1	小姐
みず	4		水		0	水、液體	飲料
...
むす	2		蒸す		1	蒸
むすう	2		無数		2	無數
むずかしい	4		難しい		0,4,5	難理解、難解決	形容詞
むすこ（さん）	3		息子（さん）		0	兒子‧男孩
むすび	1		結		0	緊、結束、飯團
むすびつき	1		結び付き		0	聯繫、結合、關係
むすびつく	1		結び付く		4	有關係、結成一體
むすびつける	1		結び付ける		5	結合
むすぶ	2		結ぶ		0	繫、結、結合、建立關係、緊閉
むすめ（さん）	3		娘（さん）		3(0)	女兒、姑娘
むせん	1		無線		0	無線電、無線
むだ	2		無駄		0	延帶、浪費
むだづかい	1		無駄遣い		3	浪費
むだん	1		無断		1	擅自、私自
...
メートル	4		mètre	フランス語	0	公尺
メール//ｅメール//Ｅメール	2	*0	mail		0,1	電子郵件、信件
めかた	1		目方		0	重量
めがね	4		眼鏡		1	眼鏡
めぐまれる	2		恵まれる		0	賦予
めぐみ	1		恵み		0	恩惠
...
めざめる	1		目覚める		3	覺醒
めし	2		飯		2	飯
めしあがる	3		召し上がる		0,4,5	〔尊敬語〕吃、喝、吸
めした	2		目下		0,3	部下
めじるし	2		目印		2	記號
めす	1		召す		1	召見
めす	1		雌		2	雌
めずらしい	3		珍しい		4	新奇的、罕見的
めだつ	2		目立つ		2	顯眼
...
めんどくさい	0		面倒臭い		5	非常麻煩
メンバー	2		member		1	成員、選手
めんぼく・めんもく	1		面目		0	面目、名譽
も	1	*0	喪		0	居喪
もう	4		もう「もう一度」		0	另外、再
もう	4		もう「もう、帰りました」		1	已經、既
もう	1		〜網			網
もうかる	2		儲かる		3	賺錢、得便宜
もうける	2		儲ける		3	賺錢、得利
もうける	1		設ける		3	預備
もうしあげる	3		申し上げる		0,5	〔謙讓語〕說、講
...
もん	2		〜問			質問
もんく	2		文句		1	話說、不滿
もんだい	4		問題		0	問題、(麻煩)事件
もんどう	2		問答		1,3	爭論
や	4		〜屋			〜店
や	2		〜夜			夜、夜晩
や	1		矢		1	箭
やおや	4		八百屋		0	蔬菜店、蔬菜商人
やがい	1		野外		0,1	郊外
やがて	2		軈て		0	不久
やかましい	2		喧しい		4	吵鬧的
やかん	2		薬缶		0	水壺
...
やくそく（する）	3		約束（する）		0	約定、約會
やくだつ	2		役立つ		3	有用、有益
やくにたつ	3		役に-立つ		2--1	有益處
やくにん	2		役人		0	官史
やくば	1		役場		3	地方行政機關
やくひん	2		薬品		0	藥品
やくめ	2		役目		3	職務、任務
...
やけど	2		火傷		0	燒傷
やけに	1		自棄に		1	非常、過於
やける	3		焼ける		0	著火、燒成、燒、熱
やこう	2		夜行		0	夜間行走、夜車
やさい	4		野菜		0	蔬菜	食物
やさしい	4		易しい		0,3	容易的、易懂	形容詞
やさしい	3		優しい		0,3	親切、溫柔、優美的	形容詞
やしき	1		屋敷		3	宅地
やしなう	1		養う		0,3	養育、培養
やじるし	2		矢印		2	箭頭
やしん	1		野心		1	野心
やすい	4		安い		2	便宜、低廉的、安穩	形容詞
やすい	3		〜易い			容易〜
やすっぽい	1		安っぽい		4	不值錢的
やすみ	4		休み		3	休息、休假
やすむ	4		休む		2	休息、停歇
...
やっと	3		やっと		0	好不容易、勉勉強強
やど	2		宿		1	房屋、旅館
やとう	2		雇う		2	雇用
やとう	1		野党		0,1	在野黨
やぬし	2		家主		0,1	房東
やね	2		屋根		1	屋頂
やはり//やっぱり	3		矢張り		2	仍然、果然、還是
やぶく	2		破く		2	破掉
...
やめる	3		止める「たばこをやめる」		0	停止、退(辭)、戒、作罷
やめる	2		辞める		0	辭職、退學
やや	2		稍		1	稍微
...
やりとげる	1		遣り遂げる		4	做完
やる	4		遣る「仕事をやる」		0	做
やる	3		遣る「「あげる」の意味」		0	給與、請進、請到
やわらかい	3		柔らかい		4	柔軟的、柔韌
...
ゆうび	1		優美		1	優美
ゆうびん	2		郵便		0	郵件
ゆうびんきょく	4		郵便局		3	郵局	地點
ゆうべ	4		昨夜［「昨晩」の意］	名詞//副詞	3//0	昨夜、昨晚
ゆうべ	2		夕べ		3	傍晩
ゆうぼう	1		有望		0	有(希)望
ゆうぼく	1		遊牧		0	游牧
ゆうめい	4		有名		0	有名、著名	形容詞
ユーモア	2		humor		1	幽默
ゆうやけ	1		夕焼け		0	晚霞
ゆうゆう	2		悠々		3	從容不迫
ゆうり	2		有利		1	有利
...
よきょう	1		余興		0	餘興
よきん	1		預金		0	存款
よく	4		良く「よく行きます」		1	經常、常常
よく	4		好く「よくできました」		1	漂亮、好
よく	2		翌〜		0	次、下一個
よく	1		欲		2	慾望
よく、いらっしゃいました。	3		よく、-いらっしゃいました。	挨拶語	1--6	觀迎、你來了
よくあつ	1		抑圧		0	壓制
よくしつ	1		浴室		0	浴室
...
よる	3		寄る		0	靠近、順路
よる	2		因る		0	基於、因為、根據
（に）よると	3		（〜に）拠ると		0	由於〜、根據〜
よろこび	2		喜び//慶び		0	喜悅//祝賀
よろこぶ	3		喜ぶ		3	高興、喜悅
よろこぶ	2		慶ぶ		3	高興、喜悅、祝
よろしい	3		宜しい		0,3	可以、適當地
（どうぞ，）よろしく。	4		（どうぞ，）宜しく。	挨拶語	(1)0	請關照、多多指教
よろん	1		輿論、世論		1	輿論
よわい	4	*3	弱い		2	弱的、不擅長	形容詞
よわまる	1		弱まる		3	變弱
よわめる	1		弱める		3	使衰弱、削弱
よわる	1		弱る		2	衰弱
よん	2		四	或者是 し	1	4	數字
...
ライト	2		light/right		1	燈、光//權利//右側;右外野手;右派	
らいにち	2		来日		0	來日本
らいねん	4		来年		0	明年
ライバル	1	*0	rival		1	對手
らく	2		楽		2	舒適、輕鬆
...
ラジオ	4		radio		1	廣播
ラジカセ	4	*0	radiocassetterecorder		0	收錄兩用收音機、錄放音機
らっか	1		落下		0,1	落下
らっかん	1		楽観		0	樂觀
ラッシュアワー	2		rushhour		4	(交通)尖峰時刻
ラベル	1		label		0,1	標籤
らん	2		欄		1	欄
ランチ	2		lunch		1	午餐、午飯
...
りっぱ	4		立派		0	美觀、堂皇、優秀、卓越、完全、光明正大
りっぽう	1		立方		0	立方
りっぽう	1		立法		0	立法
りてん	1		利点		0	優點
リボン	2		ribbon		1	緞帶
...
りょうち	1		領地		1	領地
りょうど	1		領土		1	領土
りょうほう	3		両方		0,3	兩方、雙方、兩者、兩邊、兩側
りょうり	4		料理		1	做飯菜、烹調、飯菜、菜餚	食物
りょうりつ	1		両立		0	兩立
りょかく	1		旅客		0	旅客
りょかん	3		旅館		0	旅館
りょく	2		〜力			〜力量
りょけん	1		旅券		0	護照
りょこう（する）	4		旅行（する）		0	旅行
りれき	1		履歴		0	履歴
りろん	1		理論		1	理論
りんぎょう	1		林業		0,1	林業
りんじ	2		臨時		0	臨時
...
れんちゅう	1		連中		0,1	夥伴
レントゲン	1		Röntgen	ドイツ語	0,3	Ｘ光線、倫琴射線
れんぽう	1		連邦		0	聯邦
れんめい	1		連盟		0	聯盟
れんらく（する）	3		連絡（する）		0	聯絡、聯繫、通訊
ろうか	4	*2	廊下		0	走廊
ろうじん	2		老人		0,3	老人
ろうすい	1		老衰		0	衰老
ろうそく	2		蝋燭		3,4	蠟燭
...
わ	2		輪		1	圈、車輪
わ〜	2		和〜「日本」		1	日式
ワープロ	3	*0	wordprocessor		0	文字處理機
ワイシャツ	4		whiteshirt		0	襯衫	服裝
ワイン	2		wine		1	葡萄酒
わえい	2		和英		0	日英
わが	2		我が〜		1	我的〜、我們的〜
わかい	4		若い		2	年輕的、年少的、幼稚、朝氣蓬勃
わかす	3		沸かす		0	燒開、使…沸騰、使興高采烈
わがまま	2		我が儘		4,3	任性
わかもの	1	*0	若者		0	年青人、青年
わかる	4		分かる		2	明白、知道、懂、理解
わかれ	2		別れ、分れ		3	別離、分別、分手
わかれる	3		別れる		3	告別、（夫婦）離婚
...
わずか	2		僅か		1	僅
わずらわしい	1		煩わしい		0,5	煩
わすれもの	3		忘れ物		0	忘記帶、忘記拿、忘了拿的東西
わすれる	4		忘れる		0	忘記、忘掉、忘懷、遺忘
わた	2		綿		2	棉
わだい	2		話題		0	話題
わたくし	4		私		0	〔敬語〕我
わたし	4		私		0	我
わたす	4		渡す		0	交付、給予、讓給、渡、架
わたりどり	1		渡り鳥		3	候鳥
わたる	4		渡る		0	渡、經過
ワット	1		watt		1	瓦(特)
わび	1		詫び		0	歉意
...
わら	1		藁		1	稻草
わらい	2		笑い		0	笑
わらう	3		笑う		0	笑、可笑、不知羞恥
わり	1		〜割		1	〜成
わりあい	3		割合		0	比率
わりあいに	3		割合に		0	比較、雖然…但是
わりあて	1		割当		0	分攤
わりこむ	1		割込む		3	擠進
わりざん	2		割算		2	除法
...
わるい	4		悪い		2	壞、差、不好、（情況）不正常	形容詞
わるくち	2		悪口		2	壞話
わるもの	1		悪者		0	壞人
われ	1		我		1	我、自己
われる	3		割れる		0	碎、壞、破壞、破裂
われわれ	2		我々		0	我們
わん	2		碗、椀		0	碗
わん	2		湾		0	海灣
